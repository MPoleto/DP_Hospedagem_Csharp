...
2. O método `ObterQuantidadeHospedes` da classe Reserva deverá retornar a quantidade total de hóspedes, enquanto que o método `CalcularValorDiaria` deverá retornar o valor total da reserva (Dias reservados x valor da diária).
